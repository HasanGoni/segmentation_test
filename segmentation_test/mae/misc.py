...
# %% auto 0
__all__ = ['SmoothedValue', 'MetricLogger', 'test_update', 'test_getattr', 'test_str', 'test_synchronize_between_processes',
           'test_add_meter', 'test_log_every', 'setup_for_distributed', 'is_dist_avail_and_initialized',
           'get_world_size', 'get_rank', 'test_get_rank_not_initialized', 'is_main_process', 'save_on_master',
           'init_distributed_mode', 'get_grad_norm_', 'test_get_grad_norm_', 'save_model', 'load_model',
           'all_reduce_mean']
